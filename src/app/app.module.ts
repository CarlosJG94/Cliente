...
@NgModule({
  declarations: [AppComponent, GraficaComponent, MenuComponent,CalculadosComponent,GraficasComponent,DerivadaComponent, RegistrarseComponent, RegistrosComponent ,UploadComponent, LoginComponent],
  imports: [
    BrowserModule, 
    FormsModule, 
    HttpModule, 
