(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('bergben-angular2-file-drop')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/platform-browser', 'bergben-angular2-file-drop'], factory) :
	(factory((global['ng2-file-input'] = global['ng2-file-input'] || {}),global.ng.core,global._angular_platformBrowser,global.bergbenAngular2FileDrop));
}(this, (function (exports,_angular_core,_angular_platformBrowser,bergbenAngular2FileDrop) { 'use strict';

var Ng2FileInputOptions = (function () {
    function Ng2FileInputOptions() {
        this.dropText = "Drop file here";
...
exports.Ng2FileInputComponent = (function () {
    function Ng2FileInputComponent(sanitizer, defaultOptions) {
        this.sanitizer = sanitizer;
        this.defaultOptions = defaultOptions;
        this.alreadyEmitted = false;
        this.fileIsOver = false;
        this.invalidFile = false;
        this.output = new _angular_core.EventEmitter();
        this.currentFiles = [];
    }
...
], exports.Ng2FileInputComponent.prototype, "dropText", void 0);
__decorate([
    _angular_core.Input('browse-text')
], exports.Ng2FileInputComponent.prototype, "browseText", void 0);
__decorate([
    _angular_core.Input('remove-text')
], exports.Ng2FileInputComponent.prototype, "removeText", void 0);
__decorate([
    _angular_core.Input('invalid-file-text')
], exports.Ng2FileInputComponent.prototype, "invalidFileText", void 0);
__decorate([
    _angular_core.Input('invalid-file-timeout')
], exports.Ng2FileInputComponent.prototype, "invalidFileTimeout", void 0);
__decorate([
    _angular_core.Input('multiple')
], exports.Ng2FileInputComponent.prototype, "multiple", void 0);
__decorate([
    _angular_core.Input('removable')
], exports.Ng2FileInputComponent.prototype, "removable", void 0);
__decorate([
    _angular_core.Input('show-previews')
], exports.Ng2FileInputComponent.prototype, "showPreviews", void 0);
__decorate([
    _angular_core.Input('extensions')
], exports.Ng2FileInputComponent.prototype, "extensions", void 0);
__decorate([
    _angular_core.Output('onChange')
], exports.Ng2FileInputComponent.prototype, "output", void 0);
exports.Ng2FileInputComponent = __decorate([
    ...
    __param(0, _angular_core.Inject(_angular_core.forwardRef(function () { return _angular_platformBrowser.DomSanitizer; }))), __param(1, _angular_core.Inject(_angular_core.forwardRef(function () { return Ng2FileInputOptions; })))
...
exports.Ng2FileInputModule = Ng2FileInputModule_1 = (function () {
...
exports.Ng2FileInputModule = Ng2FileInputModule_1 = __decorate$1([
    _angular_core.NgModule({
        imports: [
            _angular_platformBrowser.BrowserModule,
            bergbenAngular2FileDrop.FileDropModule
        ],
        declarations: [exports.Ng2FileInputComponent],
        exports: [exports.Ng2FileInputComponent]
    })
], exports.Ng2FileInputModule);
